...
- Runs as an optional Podman service (`open-webui`) managed by `init/start/stop/status/logs`.
...
- Keep Open WebUI service optional and configuration-driven; do not bake plugin installs into `airpods init/start`.
